...
export const AuthPage: React.FC<AuthPageProps> = ({ onLogin }) => {
  ...
  return (
    <div className="h-full w-full bg-zinc-950 overflow-y-auto relative">
      ...
      {/* Language Toggle (Absolute to container) */}
      <button 
      ...
      {/* Content Wrapper - Centers content but allows scrolling if height exceeds screen */}
      <div className="min-h-full flex flex-col items-center justify-center p-4 relative z-10 py-12">
